...
export function AboutSection() {
  return (
    <section id="about" className="relative py-24 lg:py-28 bg-[#05070A] border-t" style={{ borderColor: "#1E293B" }}>
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className="text-[clamp(2rem,4.5vw,3rem)] font-bold tracking-[-0.02em] leading-[1.1] mb-6" style={{ color: "#E2E8F0" }}>
              {aboutText.heading}
            </h2>
          ...
          >
            {trustStats.map((stat, idx) => (
              ...
              >
                <span className="text-[clamp(1.75rem,3vw,2.5rem)] font-bold tracking-[-0.02em] block mb-1" style={{ color: "#E2E8F0" }}>
                  {stat.value}
                </span>
