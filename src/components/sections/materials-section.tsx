...
export function MaterialsSection() {
  return (
    <section id="materials" className="relative py-24 lg:py-28 bg-[#F8FAFC] border-t" style={{ borderColor: "#E2E8F0" }}>
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg mt-4 max-w-[600px] leading-relaxed" style={{ color: "#64748B" }}>
            We'll help you choose. From everyday PLA to industrial-grade
            carbon fibre composites — there's a material for your project.
          </p>
        </motion.div>
          ...
          {materials.map((material, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4 mt-2">
                ...
                <h3 className="text-xl font-bold tracking-[-0.01em]" style={{ color: "#0F172A" }}>
                  {material.name}
                </h3>
              </div>
                ...
                {material.stats.map((stat) => (
                  <div key={stat.label} className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="text-[11px] font-semibold tracking-widest uppercase mb-0.5" style={{ color: "#94A3B8" }}>
                        {stat.label}
                      </p>
