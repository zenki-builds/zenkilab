      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <p className="text-neutral-500 text-lg mt-4 max-w-[600px] leading-relaxed">
            From prototyping to end-use production parts, our materials are selected
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {materials.map((material, idx) => (
            <motion.div
              ...
              className="group relative bg-[#1a1a1a] border border-white/[0.06] rounded-2xl p-8 lg:p-9 hover:border-white/[0.12] transition-all duration-500 hover:-translate-y-1"
            >
              {/* Color indicator bar */}
              <div
